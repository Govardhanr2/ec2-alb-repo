...
echo 'Namaste from G Container2' > /tmp/index.html
...
server {
    listen 80;
    server_name ec2-instance2.${domain_name};
    location / {
        default_type text/plain;
        return 200 'Hello from G Instance2';
    }
    location = /health {
        default_type text/plain;
        return 200 'OK';
...
server {
    listen 80;
    server_name ec2-docker2.${domain_name};
    location / {
